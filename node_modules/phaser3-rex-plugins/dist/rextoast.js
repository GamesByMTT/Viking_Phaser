(function (global, factory) {
    ...
    */
    ...
    var RunCommands = function (queue, scope, config) {
        var reverse = GetValue$B(config, 'reverse', false);
    ...
    var RunCommand = function (cmd, scope, config) {
        var argsConvert = GetValue$B(config, 'argsConvert', undefined);
        var argsConvertScope = GetValue$B(config, 'argsConvertScope', undefined);
        ...
        if (typeof (fnName) === 'string') {
            fn = scope[fnName];
            if (fn == null) {
                fn = GetValue$B(scope, fnName, null);
            }
        } else {
            fn = fnName;
        }
