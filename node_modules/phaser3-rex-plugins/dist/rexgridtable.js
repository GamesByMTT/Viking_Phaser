    ...
    */
    ...
    class TickTask extends ComponentBase {
        constructor(parent, config) {
            ...
            this.setTickingMode(GetValue$10(config, 'tickingMode', 1));
            // boot() later
        }
    ...
    var GetValue$T = function (source, key, defaultValue) {
    ...
    */
    ...
    class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var origin = GetValue$x(config, 'origin', 0.5);
            var originX = GetValue$x(config, 'originX', origin);
            var originY = GetValue$x(config, 'originY', origin);
            this.setOrigin(originX, originY);

            this.setMinSize(minWidth, minHeight);
            this.setName(GetValue$x(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$x(config, 'space', 0));
            ...
            this.setSizerEventsEnable(GetValue$x(config, 'sizerEvents', false));
            this.setDirty(true);
    ...
    var Add$2 = function (
        ...
        if (proportion === null) {
            ...
            align = GetValue$w(config, 'align', ALIGN_CENTER$1);
    ...
    class Sizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, orientation, config) {
            ...
            this.setStartChildIndex(GetValue$v(config, 'startChildIndex', 0));
    ...
    */
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            if (IsPlainObject$3(x)) {
                ...
                width = GetValue$m(config, 'width', 2);
                height = GetValue$m(config, 'height', 2);
                barColor = GetValue$m(config, 'barColor', undefined);
                value = GetValue$m(config, 'value', 0);
    ...
    class Slider extends ProgressBase(Sizer) {
        constructor(scene, config) {
            ...
            this.reverseAxis = GetValue$g(config, 'reverseAxis', false);
            ...
            if (thumb) {
                ...
                var thumbOffsetX = GetValue$g(config, 'thumbOffsetX', 0);
                var thumbOffsetY = GetValue$g(config, 'thumbOffsetY', 0);
            ...
            this.setGap(GetValue$g(config, 'gap', undefined));
            this.setValue(GetValue$g(config, 'value', 0), GetValue$g(config, 'min', undefined), GetValue$g(config, 'max', undefined));
    ...
    class ScrollBar extends Sizer {
        constructor(scene, config) {
            ...
            this.setValue(GetValue$f(config, 'value', 0));
            this.setScrollStep(GetValue$f(buttonsConfig, 'step', 0.01));
        }
    ...
    class MouseWheelScroller extends ComponentBase {
        constructor(gameObject, config) {
            ...
            if (this.parent !== this.scene) {
                this.focusMode = GetValue$b(config, 'focus', true);
            } else {
                this.focusMode = false;
            }

            this.setSpeed(GetValue$b(config, 'speed', 0.1));
            this.setEnable(GetValue$b(config, 'enable', true));
            ...
            if (!this.focusMode) { // Register on scene
                ...
                var gameObject = this.parent;
                gameObject
                    .setInteractive(GetValue$b(config, "inputConfig", undefined))
    ...
    var AddSlider = function (topPatent, sliderParent, axis, config) {
        ...
        if (sliderConfig) {
            ...
            3. space.child
            */
            var sliderPadding = GetValue$a(config, `space.slider${axis}`, undefined);
            ...
            if (sliderPadding === undefined) {
                ...
                if (sliderPadding === undefined) {
                    if (isScrollXYMode) {
                        ...
                        childPadding = GetValue$a(config, 'space.child', 0);
                    }
                }
            }
            ...
            if (isAxisY) {
                if (sliderPosition === 0) { // right
                    ...
                    if (childPadding === undefined) {
                        ...
                        padding = { left: GetValue$a(childPadding, 'right', childPadding) };
                    }
                    ...
                    if (childPadding === undefined) {
                        ...
                        padding = { right: GetValue$a(childPadding, 'left', childPadding) };
                    }
                }
                ...
                if (sliderPosition === 0) { // bottom
                    ...
                    if (childPadding === undefined) {
                        ...
                        padding = { top: GetValue$a(childPadding, 'bottom', childPadding) };
                    }
                    ...
                    if (childPadding === undefined) {
                        ...
                        padding = { bottom: GetValue$a(childPadding, 'top', childPadding) };
                    }
                }
            }
            ...
            topPatent[`hideUnscrollableSlider${axis}`] = GetValue$a(sliderConfig, 'hideUnscrollableSlider', false);
            topPatent[`adaptThumb${axis}SizeMode`] = GetValue$a(sliderConfig, 'adaptThumbSize', false);
            topPatent[`minThumb${axis}Size`] = GetValue$a(sliderConfig, 'minThumbSize', undefined);
        ...
        var mouseWheelScrollerConfig = GetValue$a(config, ((isScrollXYMode) ? `mouseWheelScroller${axis}` : 'mouseWheelScroller'), false),
            mouseWheelScroller;
    ...
    class Scrollable extends Sizer {
        constructor(scene, config) {
            ...
            super(scene, config);
            this.type = GetValue$8(config, 'type', 'rexScrollable');
