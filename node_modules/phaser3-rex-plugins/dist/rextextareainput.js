    ...
    */
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            if (IsPlainObject$5(x)) {
                ...
                width = GetValue$s(config, 'width', 2);
                height = GetValue$s(config, 'height', 2);
                barColor = GetValue$s(config, 'barColor', undefined);
                value = GetValue$s(config, 'value', 0);
    ...
    class Slider extends ProgressBase(Sizer) {
        constructor(scene, config) {
            ...
            this.setGap(GetValue$m(config, 'gap', undefined));
