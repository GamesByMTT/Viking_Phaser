    ...
    */
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            if (IsPlainObject$4(x)) {
                ...
                width = GetValue$h(config, 'width', 2);
                height = GetValue$h(config, 'height', 2);
                barColor = GetValue$h(config, 'barColor', undefined);
                value = GetValue$h(config, 'value', 0);
    ...
    class Slider extends ProgressBase(Sizer) {
        constructor(scene, config) {
            ...
            this.setGap(GetValue$b(config, 'gap', undefined));
                ...
                this.add(header,
                    {
                        ...
                        align: align,
                        padding: padding,
                        expand: GetValue$3(config, 'expand.header', true)
                    }
                );
            }
    ...
    class ScrollableBlock extends Base {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var clampChildOY = GetValue$1(config, 'clamplChildOY', true);
            var clampChildOX = GetValue$1(config, 'clamplChildOX', clampChildOY);
