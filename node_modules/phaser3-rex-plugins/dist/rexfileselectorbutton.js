    ...
    */
    ...
    class RenderBase extends Base {
        ...
        modifyPorperties(o) {
            ...
            // ScaleX, ScaleY
            var width = GetValue$b(o, 'width', undefined);
            var height = GetValue$b(o, 'height', undefined);
            var scaleX = GetValue$b(o, 'scaleX', undefined);
            var scaleY = GetValue$b(o, 'scaleY', undefined);
    ...
    class Background extends RenderBase {
        constructor(parent, config) {
            ...
            this.setCornerRadius(
                GetValue$9(config, 'cornerRadius', 0),
                GetValue$9(config, 'cornerIteration', null)
            );
        }
    ...
    class InnerBounds extends RenderBase {
        ...
        modifyPorperties(o) {
            ...
            if (o.hasOwnProperty('color')) {
                this.setColor(
                    o.color,
                    GetValue$8(o, 'color2', null),
                    GetValue$8(o, 'horizontalGradient', true)
                );
            }
            if (o.hasOwnProperty('stroke')) {
                this.setStroke(
                    o.stroke,
                    GetValue$8(o, 'strokeThickness', 2)
                );
            }
        }
    ...
    class TextStyle {
        ...
        set(o) {
            ...
            this.setStrokeStyle(
                GetValue$7(o, 'stroke', null),
                GetValue$7(o, 'strokeThickness', 0)
            );
            this.setShadow(
                GetValue$7(o, 'shadowColor', null),
                GetValue$7(o, 'shadowOffsetX', 0),
                GetValue$7(o, 'shadowOffsetY', 0),
                GetValue$7(o, 'shadowBlur', 0)
            );
            this.setOffset(
                GetValue$7(o, 'offsetX', 0),
                GetValue$7(o, 'offsetY', 0)
            );
            this.setSpace(
                GetValue$7(o, 'leftSpace', 0),
                GetValue$7(o, 'rightSpace', 0)
            );
    ...
    var RunWordWrap$1 = function (config) {
        ...
        var wrapMode = GetValue$6(config, 'wrapMode');
        ...
        var justifyPercentage = GetValue$6(config, 'justifyPercentage', 0.25);
    ...
    class DynamicText extends Canvas {
        constructor(scene, x, y, fixedWidth, fixedHeight, config) {
            ...
            this.setTestString(GetValue$3(config, 'testString', '|MÉqgy'));

            this._textOX = 0;
            this._textOY = 0;
            this.background = new Background(this, GetValue$3(config, 'background', undefined));
            this.innerBounds = new InnerBounds(this, GetValue$3(config, 'innerBounds', undefined));
            this.children = [];
            ...
            this.setPadding(GetValue$3(config, 'padding', 0));
            this.setWrapConfig(GetValue$3(config, 'wrap', undefined));
            this.setChildrenInteractiveEnable(GetValue$3(config, 'childrenInteractive', false));
